...
class AddGoodsListTablet extends StatefulWidget {
  const AddGoodsListTablet({
    super.key,
  });

  @override
  State<AddGoodsListTablet> createState() => _AddGoodsListTabletState();
}

class _AddGoodsListTabletState extends State<AddGoodsListTablet> {
